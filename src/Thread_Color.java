 ...
 * @author ACER
 */
public class Thread_Color implements Runnable {// implimenté interface Runnable {ta3 thread}

    index1 index = null;

    public Thread_Color(index1 index) { // constricteur the class implementé index1 xlass m3ah 
        this.index = index;
    }
    ...
    public void run() { // bach kinmachiw thread ymachi had la function 
        ...
        int hght1 = 0;
        int loop = 0;
        for (String resu : index.imgProce.CompHisto(index.Image_src, index.listImgBDD)) {
